module BackOffice
  class ProxiesController < BackOfficeController
    ...
    def proxy_params
      params.require(:proxy).permit(:name, :description, :alias, proxy_parameter_attributes: [:id, :authentication_mode, :protocol, :hostname, :port, :authentication_url, :client_id, :client_secret])
    end
